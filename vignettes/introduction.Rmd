...
The following commands are structured to behave like [`dplyr`](https://cran.rstudio.com/web/packages/dplyr/vignettes/introduction.html). They
...
```{r, echo = FALSE, message = FALSE}
key <- Sys.getenv('DATAGOV_API_KEY')
```
